...
>>>>>>> d01fb6a246395dd82ba80e0f6f9e38377ac7fd57
              Auto-Generate ID
            </button>
          </div>
        </div>
        ...
        <div className="input-group" style={{ marginTop: "20px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            <input name="employeeID" value={formData.employeeID} onChange={handleChange} placeholder="Employee ID" required={formData.role === "employee"} />
...
<<<<<<< HEAD
              ...
              >
=======
              <button type="button" onClick={() => setFormData((prev) => ({ ...prev, employeeID: generateEmployeeID() }))}>
>>>>>>> d01fb6a246395dd82ba80e0f6f9e38377ac7fd57
